...
*Author’s name: Ninghan Huang
*Last Modified by:Ninghan Huang
*Date last Modified:3-11-2016
*Program description: this script is writen to control the hero  move end  .
 *                    Sounds will be played after  touching enemys and Torches and dead.
 *                    also Lives will --  score will ++ and a pickup sound will be played.
